...
export const NPCDialogBox = ({
  ...
  // `typingDone` en vez de `isTyping`: useInView con {once:true} ya se queda en
  // true para siempre, así que "arrancó" es exactamente "está a la vista" y
  // "está escribiendo" se deriva de si la máquina de escribir ya terminó. En
  // Remix esto eran dos setState dentro de un useEffect, patrón que React 19
  // marca como render en cascada.
